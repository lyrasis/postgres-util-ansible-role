/*
run within a database to determine tables that would benefit from (auto)vacuuming
https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.PostgreSQL.CommonDBATasks.html#Appendix.PostgreSQL.CommonDBATasks.Autovacuum.NeedVacuuming
*/
